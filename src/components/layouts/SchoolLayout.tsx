  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <button
          onClick={() => setOpen(o => !o)}
          className="sticky top-4 left-4 z-50 ml-4 mt-4 flex items-center justify-center w-8 h-8 rounded-lg bg-gray-900 text-white hover:bg-gray-700 transition shadow-sm"
