...
export default function TeamPage() {
  ...
  async function handleInvite(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(data.existing ? 'Team member added successfully!' : 'Invitation sent successfully!')
  ...
  return (
    <div className="max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Invite and manage your school team members</p>
      </div>
      ...
      {pending.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-lg font-bold text-gray-900 mb-4">Pending Invitations ({pending.length})</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Email</th>
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Role</th>
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Invited</th>
                  <th className="text-right py-3 px-4 font-medium text-gray-700">Actions</th>
                </tr>
              </thead>
              <tbody>
