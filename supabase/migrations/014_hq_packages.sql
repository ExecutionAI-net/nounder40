...
-- school_students: ensure unique constraint exists
ALTER TABLE school_students ADD CONSTRAINT IF NOT EXISTS school_students_unique UNIQUE (school_id, student_id);
