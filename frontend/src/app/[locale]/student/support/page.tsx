...
export default function StudentSupportPage() {
  ...
  // ST-R3-05: l'effetto usciva subito senza sessione e `loading` restava
  // true, quindi un anonimo vedeva "Caricamento" per sempre al posto della
  // chat. La conversazione e' con la propria scuola: serve un account.
  if (!authLoading && !user) {
    return (
      <StudentLoginPrompt
        title={t('loginPromptTitle')} text={t('loginPromptText')} next="/student/support"
        icon={
