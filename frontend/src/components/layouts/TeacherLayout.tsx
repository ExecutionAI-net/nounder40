...
export default function TeacherLayout({ children }: { children: React.ReactNode }) {
  ...
  // Mobile: drawer in sovrapposizione, come Scuola/HQ
  ...
  return (
    <div className="min-h-dvh md:flex md:flex-row md:h-dvh bg-gray-50" style={sidebarCssVars(sidebarColors)}>
      ...
      {/* Drawer mobile in sovrapposizione: spinner sulla voce toccata */}
      {mobileMenuOpen && (
      ...
      {/* Main: scroll naturale su mobile, app-shell da md in su */}
